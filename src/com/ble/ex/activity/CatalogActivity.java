...
public class CatalogActivity extends BaseActivity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		logoImageView = (ImageView) this.findViewById(R.id.logoImage);
	...
	public void onClick(View view) {
		if (view.getId() == R.id.logoImage){
			Constants.SECURITY_VERSION = !Constants.SECURITY_VERSION;
			Toast.makeText(this, Constants.SECURITY_VERSION?"已切换到认证加密版本":"已切换到 非 认证版本", Toast.LENGTH_SHORT).show();
		}
